    ...
    <>
      ...
      <Container className="container d-flex flex-column justify-content-center align-items-center">
        <div className="section mb-4 w-100">
          <h2 style={{ fontFamily: 'Baloo Bhai 2', fontWeight: 700, fontSize: '2rem' }}>Read Your Future Now</h2>
          <Row className="row-cols-1 row-cols-md-3 g-4">
            <Col>
              <div className="box">
                <img src={tarot} alt="Tarot Reading" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Tarot Reading</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={angel} alt="Angel Reader" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Angel Reader</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={ketinaLove} alt="Katina Love Reading" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Katina Love Reading</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={face} alt="Face Reader" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Face Reader</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={palm} alt="Palm Reader" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Palm Reader</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={finger} alt="Finger Reader" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Finger Reader</h3>
              </div>
            </Col>
          </Row>
        </div>
          ...
          <Row className="row-cols-1 row-cols-md-3 g-4">
            <Col>
              <div className="box">
                ...
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Time Travel</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={astrology} alt="Astrology" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Astrology</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={biorythm} alt="Biorythm" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Biorythm</h3>
              </div>
            </Col>
          </Row>
        </div>
        <div className="section mb-4 w-100">
          ...
          <Row className="row-cols-1 row-cols-md-3 g-4">
            <Col>
              <div className="box">
                <img src={dreamInterpretation} alt="Dream Interpretation" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Dream Interpretation</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={crystalBall} alt="Crystal Ball" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Crystal Ball</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={numerology} alt="Numerology" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Numerology</h3>
              </div>
            </Col>
          </Row>
        </div>
          ...
          <Row className="row-cols-1 row-cols-md-3 g-4">
            <Col>
              <div className="box">
                ...
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Meditation</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={emotionalSupport} alt="Emotional Support" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Emotional Support</h3>
              </div>
            </Col>
            <Col>
              <div className="box">
                <img src={getyoursolution} alt="Get Your Solutions" className="img-fluid" />
                <h3 className="mt-3" style={{ fontFamily: 'Inter', fontWeight: 'Bold' }}>Get Your Solutions</h3>
              </div>
            </Col>
          </Row>
